...
export function NoteModal({ initialNote = '', onSave, onCancel }: NoteModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center animate-fadeIn pointer-events-auto" style={{ height: '100vh', width: '100vw', margin: 0, padding: 0, backgroundColor: 'rgba(0,0,0,0.5)' }}>
